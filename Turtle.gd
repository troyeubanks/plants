...
func draw_leaf(length: float, theta: float, color: Color) -> void:
	...
	if true:
		...
		# stem side of leaf
		# surface_tool.add_color(Color(1.0, 0.0, 0.0, 1.0))
		surface_tool.add_vertex(initial_pos)
		yaw(theta)
		move_forward(length)
		# surface_tool.add_color(Color(0.0, 1.0, 0.0, 1.0))
		surface_tool.add_vertex(_pos)
		yaw(theta * 5)
		move_forward(length)
		# surface_tool.add_color(Color(0.0, 0.0, 1.0, 1.0))
		surface_tool.add_vertex(_pos)
